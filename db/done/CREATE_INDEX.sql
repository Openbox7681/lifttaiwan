...
ALTER TABLE hisac.dbo.report ADD MemberId bigint go
ALTER TABLE hisac.dbo.report ADD OrgId bigint go
ALTER TABLE hisac.dbo.report ADD MemberRoleId bigint go
