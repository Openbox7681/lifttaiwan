...
@Entity
@Table(name="v_incident_member")
public class ViewIncidentMember {
	...
	private String contactorIdName;
	...
	@Column(name = "HandleIdName")
	public String getHandleIdName() {
		return handleIdName;
	}
	public void setHandleIdName(String handleIdName) {
		this.handleIdName = handleIdName;
	}
	...
	@Column(name = "ContactorIdName")
	public String getContactorIdName() {
		return contactorIdName;
	}
	public void setContactorIdName(String contactorIdName) {
		this.contactorIdName = contactorIdName;
	}
