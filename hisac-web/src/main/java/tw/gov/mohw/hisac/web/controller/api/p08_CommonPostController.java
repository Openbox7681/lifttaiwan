...
public class p08_CommonPostController extends BaseController {
	...
	private String targetActionName = "p08";
	 ...
	 * @return 文章資料
	 */
	@RequestMapping(value = "/p08/query/id", method = RequestMethod.POST)
	public String QueryById(Locale locale, HttpServletRequest request, Model model, @RequestBody String json) {
		...
		if (menuService.getReadPermission(getBaseMemberId(), targetControllerName, targetActionName)) {
			...
			CommonPost commonPost = commonPostService.findForPub((long) 2);
	 ...
	 * @return 文章附件資料
	 */
	@RequestMapping(value = "/p08/attach/query", method = RequestMethod.POST)
	 ...
	 *            圖檔Id
	 */
	@RequestMapping(value = "/p08/pic/download/{commomPostId}/{id}", method = RequestMethod.GET)
	 ...
	 *            附件Id
	 */
	@RequestMapping(value = "/p08/attach/download/{commomPostId}/{id}", method = RequestMethod.GET)
