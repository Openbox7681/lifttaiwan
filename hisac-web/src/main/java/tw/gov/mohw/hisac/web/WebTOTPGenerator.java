...
public class WebTOTPGenerator extends WebHOTPGenerator {
	 ...
	 * ({@value tw.gov.mohw.hisac.web.WebHOTPGenerator#DEFAULT_PASSWORD_LENGTH}
	 * decimal digits), and HMAC algorithm
	 * ({@value tw.gov.mohw.hisac.web.WebHOTPGenerator#HOTP_HMAC_ALGORITHM}).
	 *
	 ...
	 *            {@value tw.gov.mohw.hisac.web.WebTOTPGenerator#TOTP_ALGORITHM_HMAC_SHA1},
	 *            {@value tw.gov.mohw.hisac.web.WebTOTPGenerator#TOTP_ALGORITHM_HMAC_SHA256},
	 *            and
	 *            {@value tw.gov.mohw.hisac.web.WebTOTPGenerator#TOTP_ALGORITHM_HMAC_SHA512}
	 *
	 * @throws NoSuchAlgorithmException
	 *             if the underlying JRE doesn't support HMAC-SHA1, which should
	 *             never happen except in cases of serious misconfiguration
	 *
	 * @see tw.gov.mohw.hisac.web.WebTOTPGenerator#TOTP_ALGORITHM_HMAC_SHA1
	 * @see tw.gov.mohw.hisac.web.WebTOTPGenerator#TOTP_ALGORITHM_HMAC_SHA256
	 * @see tw.gov.mohw.hisac.web.WebTOTPGenerator#TOTP_ALGORITHM_HMAC_SHA512
	 */
	public WebTOTPGenerator(final long timeStep, final TimeUnit timeStepUnit,
