...
public class s35_CommonPostController extends BaseController {
	...
	private String targetActionName = "s35";
	 ...
	 * @return 文章資料
	 */
	@RequestMapping(value = "/s35/query", method = RequestMethod.POST)
	public String Query(Locale locale, HttpServletRequest request, Model model, @RequestBody String json) {

		JSONObject obj = new JSONObject(json);
		// 指定 PostType 為 2: [組織架構管理]
		obj.put("PostType", 2);
		json = obj.toString();
	 ...
	 * @return 文章資料
	 */
	@RequestMapping(value = "/s35/query/id", method = RequestMethod.POST)
	 ...
	 * @return 是否新增成功
	 */
	@RequestMapping(value = "/s35/create", method = RequestMethod.POST)
	 ...
	 * @return 是否更新成功
	 */
	@RequestMapping(value = "/s35/update", method = RequestMethod.POST)
	 ...
	 * @return 是否刪除成功
	 */
	@RequestMapping(value = "/s35/delete", method = RequestMethod.POST)
	 ...
	 * @return 圖片資料
	 */
	@RequestMapping(value = "/s35/pic/query", method = RequestMethod.POST)
		...
		if (menuService.getReadPermission(getBaseMemberId(), targetControllerName, targetActionName)) {
			...
			if (commonPostPics != null) {
				for (ViewCommonPostPicMember commonPostPic : commonPostPics) {
					...
					String imageLink = "<img src=\"./api/p08/pic/download/" + commonPostId + "/" + commonPostPic.getId() + "\" title=\"" + commonPostPic.getFileDesc() + "\" width=\"" + commonPostPic.getImageWidth() + "\">";
					// 準備各筆資料 JSON
					JSONObject sn_json = new JSONObject();
	 ...
	 * @return 是否更新成功
	 */
	@RequestMapping(value = "/s35/pic/upload", method = RequestMethod.POST)
	 ...
	 * @return 是否刪除成功
	 */
	@RequestMapping(value = "/s35/pic/delete", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/s35/pic/download/{commomPostId}/{id}", method = RequestMethod.GET)
	 ...
	 * @return 文章附件資料
	 */
	@RequestMapping(value = "/s35/attach/query", method = RequestMethod.POST)
	 ...
	 * @return 是否更新成功
	 */
	@RequestMapping(value = "/s35/attach/upload", method = RequestMethod.POST)
	 ...
	 * @return 是否刪除成功
	 */
	@RequestMapping(value = "/s35/attach/delete", method = RequestMethod.POST)
	 ...
	 */
	@SuppressWarnings("deprecation")
	@RequestMapping(value = "/s35/attach/download/{commomPostId}/{id}", method = RequestMethod.GET)
