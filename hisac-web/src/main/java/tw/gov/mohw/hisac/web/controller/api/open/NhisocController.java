...
public class NhisocController {
	...
	private String baseControllerName = "NhisocAPI";
	 ...
	 * @return 是否新增成功
	 */
	@RequestMapping(value = "/nhisoc", method = RequestMethod.POST)
	public String CreateNHISOC(Locale locale, HttpServletRequest request, HttpServletResponse response, Model model, @RequestBody String json) {
		...
		if (WebNet.isAllowIp(resourceMessageService.getMessageValue("nhisocAllowIp"), WebNet.getIpAddr(request))) {
			JSONObject obj = new JSONObject(json);
			String incidentId = obj.isNull("IncidentId") == true ? null : obj.getString("IncidentId");
			incidentId = "nhisoc-" + incidentId;
			obj.put("SourceCode", "NHISOC");
	 ...
	 * @return 是否成功
	 */
	@RequestMapping(value = "/nhisoc/attach/upload", method = RequestMethod.POST)
	public String UploadAttach(Locale locale, HttpServletRequest request, HttpServletResponse response, Model model, @RequestBody String json) {
		...
		if (WebNet.isAllowIp(resourceMessageService.getMessageValue("nhisocAllowIp"), WebNet.getIpAddr(request))) {
			...
			informationExchangeId = "nhisoc-" + informationExchangeId;
	 ...
	 *            附件Id
	 */
	@RequestMapping(value = "/nhisoc/attach/download/{informationExchangeId}/{id}", method = RequestMethod.GET)
