...
@Entity
@Table(name = "v_incident_attach_member", uniqueConstraints = {@UniqueConstraint(columnNames = "Id")})
public class ViewIncidentAttachMember {
	private Long id;
	private Long incidentId; // 事故單Id
