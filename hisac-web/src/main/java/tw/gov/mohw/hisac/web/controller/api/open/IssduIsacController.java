...
public class IssduIsacController {
	...
	private String baseControllerName = "IssduAPI";
	 ...
	 * @return 是否新增成功
	 */
	@RequestMapping(value = "/issdu_isac", method = RequestMethod.POST)
	public String Create(Locale locale, HttpServletRequest request, HttpServletResponse response, Model model, @RequestBody String json) {
		...
		if (WebNet.isAllowIp(resourceMessageService.getMessageValue("issduisacAllowIp"), WebNet.getIpAddr(request))) {
			JSONObject obj = new JSONObject(json);
			String incidentId = obj.isNull("IncidentId") == true ? null : obj.getString("IncidentId");
			incidentId = "issdu-" + incidentId;
			obj.put("SourceCode", "ISSDU");
	 ...
	 * @return 是否成功
	 */
	@RequestMapping(value = "/issdu_isac/attach/upload", method = RequestMethod.POST)
	public String UploadAttach(Locale locale, HttpServletRequest request, HttpServletResponse response, Model model, @RequestBody String json) {
		...
		if (WebNet.isAllowIp(resourceMessageService.getMessageValue("issduisacAllowIp"), WebNet.getIpAddr(request))) {
			...
			informationExchangeId = "issdu-" + informationExchangeId;
	 ...
	 *            附件Id
	 */
	@RequestMapping(value = "/issdu_isac/attach/download/{informationExchangeId}/{id}", method = RequestMethod.GET)
