...
@Entity
@Table(name = "information_exchange", uniqueConstraints = {@UniqueConstraint(columnNames = "Id")})
public class InformationExchange {
	...
	//110.02.03 新增512欄位
	private String associatedObjected;
	private String incidentVendor;
	private String incidentDescription;
	private String incidentToolType;
	...
	@Column(name = "AssociatedObjects")
	public String getAssociatedObjected() {
		return associatedObjected;
		
	}
	public void setAssociatedObjected(String associatedObjected) {
		this.associatedObjected = associatedObjected;
	}
	
	@Column(name = "IncidentVendor")
	public String getIncidentVendor() {
		return incidentVendor;
		
	}
	public void setIncidentVendor(String incidentVendor) {
		this.incidentVendor = incidentVendor;
	}
	...
	@Column(name = "IncidentToolType")
	public String getIncidentToolType() {
		return incidentToolType;
		
	}
	public void setIncidentToolType(String incidentToolType) {
		this.incidentToolType = incidentToolType;
	}
