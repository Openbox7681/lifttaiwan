...
public class p07_CommonPostController extends BaseController {
	...
	private String targetActionName = "p07";
	 ...
	 * @return 文章資料
	 */
	@RequestMapping(value = "/p07/query/id", method = RequestMethod.POST)
	 ...
	 * @return 文章附件資料
	 */
	@RequestMapping(value = "/p07/attach/query", method = RequestMethod.POST)
	 ...
	 * 			圖檔Id
	 */
	@RequestMapping(value = "/p07/pic/download/{commomPostId}/{id}", method = RequestMethod.GET)
	 ...
	 * 			附件Id
	 */
	@RequestMapping(value = "/p07/attach/download/{commomPostId}/{id}", method = RequestMethod.GET)
