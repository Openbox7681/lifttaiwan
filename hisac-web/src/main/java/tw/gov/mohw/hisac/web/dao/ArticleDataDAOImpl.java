...
@Repository
@Transactional
public class ArticleDataDAOImpl extends BaseSessionFactory implements ArticleDataDAO {
	...
	public ArticleData get(Long id) {
		return getSessionFactory().getCurrentSession().get(ArticleData.class, id);
	}
	...
	public List<ArticleData> getList(JSONObject obj) {
		...
		Criteria cr = getSessionFactory().getCurrentSession().createCriteria(ArticleData.class);
		if (id != 0) {
