...
public class p09_CommonPostController extends BaseController {
	...
	private String targetActionName = "p09";
	 ...
	 * @return 文章資料
	 */
	@RequestMapping(value = "/p09/query/id", method = RequestMethod.POST)
	public String QueryById(Locale locale, HttpServletRequest request, Model model, @RequestBody String json) {
		...
		if (menuService.getReadPermission(getBaseMemberId(), targetControllerName, targetActionName)) {
			...
			CommonPost commonPost = commonPostService.findForPub((long) 3);
	 ...
	 * @return 文章附件資料
	 */
	@RequestMapping(value = "/p09/attach/query", method = RequestMethod.POST)
	 ...
	 *            圖檔Id
	 */
	@RequestMapping(value = "/p09/pic/download/{commomPostId}/{id}", method = RequestMethod.GET)
	 ...
	 *            附件Id
	 */
	@RequestMapping(value = "/p09/attach/download/{commomPostId}/{id}", method = RequestMethod.GET)
