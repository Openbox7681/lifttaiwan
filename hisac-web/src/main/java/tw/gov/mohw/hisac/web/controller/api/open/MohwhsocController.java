...
public class MohwhsocController {
	...
	private String baseControllerName = "MohwhsocAPI";
	 ...
	 * @return 是否新增成功
	 */
	@RequestMapping(value = "/mohwhsoc", method = RequestMethod.POST)
	public String CreateMOHWHSOC(Locale locale, HttpServletRequest request, HttpServletResponse response, Model model, @RequestBody String json) {
		...
		if (WebNet.isAllowIp(resourceMessageService.getMessageValue("mohwhsocAllowIp"), WebNet.getIpAddr(request))) {
			JSONObject obj = new JSONObject(json);
			String incidentId = obj.isNull("IncidentId") == true ? null : obj.getString("IncidentId");
			incidentId = "mohwhsoc-" + incidentId;
			obj.put("SourceCode", "MOHWHSOC");
	 ...
	 * @return 是否成功
	 */
	@RequestMapping(value = "/mohwhsoc/attach/upload", method = RequestMethod.POST)
	public String UploadAttach(Locale locale, HttpServletRequest request, HttpServletResponse response, Model model, @RequestBody String json) {
		...
		if (WebNet.isAllowIp(resourceMessageService.getMessageValue("mohwhsocAllowIp"), WebNet.getIpAddr(request))) {
			...
			informationExchangeId = "mohwhsoc-" + informationExchangeId;
	 ...
	 *            附件Id
	 */
	@RequestMapping(value = "/mohwhsoc/attach/download/{informationExchangeId}/{id}", method = RequestMethod.GET)
