...
public class s11_FormController extends BaseController {
	 ...
	 * @return Form資料
	 */
	@RequestMapping(value = "/s11/query", method = RequestMethod.POST)
	 ...
	 * @return Form資料
	 */
	@RequestMapping(value = "/s11/query/id", method = RequestMethod.POST)
	 ...
	 * @return subsystem資料
	 */
	@RequestMapping(value = "/s11/getsubsystem", method = RequestMethod.POST)
	 ...
	 * @return 是否新增成功
	 */
	@RequestMapping(value = "/s11/create", method = RequestMethod.POST)
	public @ResponseBody String Create(Locale locale, HttpServletRequest request, @RequestBody String json) {
		...
		if (menuService.getCreatePermission(getBaseMemberId(), targetControllerName, targetActionName)) {
			Form form = formService.insert(getBaseMemberId(), json);
			if (form != null) {
	 ...
	 * @return 是否更新成功
	 */
	@RequestMapping(value = "/s11/update", method = RequestMethod.POST)
	public @ResponseBody String Update(Locale locale, HttpServletRequest request, @RequestBody String json) {
		...
		if (menuService.getUpdatePermission(getBaseMemberId(), targetControllerName, targetActionName)) {
			...
			if (!formService.isExist(id)) {
				...
				Form form = formService.update(getBaseMemberId(), json);
				if (form != null) {
	 ...
	 * @return 是否刪除成功
	 */
	@RequestMapping(value = "/s11/delete", method = RequestMethod.POST)
