...
import tw.gov.mohw.hisac.web.dao.CommonPostPicDAO;
 ...
 */
@Service
public class CommonPostPicService {
	@Autowired
	CommonPostPicDAO commonPostPicDAO;
	...
	public List<CommonPostPic> getAll() {
		return commonPostPicDAO.getAll();
	}
	...
	public List<ViewCommonPostPicMember> getAllByCommonPostId(long commonPostId) {
		try {
			return commonPostPicDAO.getAllByCommonPostId(commonPostId);
		} catch (Exception e) {
			return null;
		}
	}
	...
	public long getListSize(String json) {
		try {
			...
			return commonPostPicDAO.getListSize(obj);
		} catch (Exception e) {
			return 0;
		}
	}
	 ...
	 * @return 引用圖檔資料
	 */
	public CommonPostPic insert(long memberId, String json, byte[] bytes) {
		try {
			JSONObject obj = new JSONObject(json);
			...
			Date now = new Date();
			CommonPostPic entity = new CommonPostPic();
			...
			commonPostPicDAO.insert(entity);
			return entity;
		} catch (Exception e) {
			//e.printStackTrace();
			return null;
	 ...
	 * @return 文章附加圖檔資料
	 */
	public CommonPostPic update(long memberId, String json) {
		try {
			JSONObject obj = new JSONObject(json);
			...
			CommonPostPic entity = commonPostPicDAO.get(id);
			entity.setFileDesc(fileDesc);
			entity.setModifyId(memberId);
			entity.setModifyTime(now);
			commonPostPicDAO.update(entity);
	...
	public boolean delete(Long id) {
		try {
			CommonPostPic entity = commonPostPicDAO.get(id);
			commonPostPicDAO.delete(entity);
			return true;
		} catch (Exception e) {
			//e.printStackTrace();
			return false;
	 ...
	 * @return 文章附加圖檔資料
	 */
	public CommonPostPic getById(Long id) {
		return commonPostPicDAO.get(id);
	}
	/**
	 * 文章附加圖檔資料是否存在
	 * 
	...
	public boolean isExist(Long id) {
		return commonPostPicDAO.get(id) != null;
	}
