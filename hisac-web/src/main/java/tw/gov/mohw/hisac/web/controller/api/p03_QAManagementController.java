...
//public class p03_QAManagementController extends BaseController {
//
//	@Autowired
...
//	private String targetActionName = "p03";
//
//	/**
//	 * 取得常見問題資料API
//	 * 
...
//	 * @return 常見問題資料
//	 */
//	@RequestMapping(value = "/p03/query", method = RequestMethod.POST)
...
//	 * @return 常見問題資料
//	 */
//	@RequestMapping(value = "/p03/query/id", method = RequestMethod.POST)
...
//	 * @return 附件資料
//	 */
//	@RequestMapping(value = "/p03/attach/query", method = RequestMethod.POST)
...
//	 *            附件Id
//	 */
//	@RequestMapping(value = "/p03/attach/download/{qaManagementId}/{id}", method = RequestMethod.GET)
