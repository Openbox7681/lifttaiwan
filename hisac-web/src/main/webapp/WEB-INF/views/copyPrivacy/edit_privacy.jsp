	...
	<%@ include file="../include/slidebar.jsp"%>
      ...
      <div class="col-md-12 hcenter">
          ...
          <div class="explain">
            ...
            <input class="form-control" type="text" placeholder="輸入修改內容" id="title" name="title"
               aria-label="詳閱內容" aria-describedby="basic-addon2">
          </div>
          <div class="col-md-12">
          <h6>第一條、隱私權保護政策的適用範圍</h6>
          <div class="line_div"></div><span>本隱私權政策聲明適用於本平台所提供的服務。在您瀏覽或使用本平台各項服務與資訊過程中，涉及個人資料蒐集、處理、利用與保護之原則與相關作法。   </span>
          <textarea class="form-control" placeholder="輸入修改內容"  id="item1" name="item1" rows="2" cols="50"></textarea>
        </div>
        <div class="col-md-12">
          <h6>第二條、資料之蒐集與使用方式</h6>
          <div class="line_div"></div>
         	<p>本平台個人資料的蒐集、處理、利用，將遵守中華民國「個人資料保護法」及相關法律之規範。</p>
          	<textarea class="form-control" placeholder="輸入修改內容"  id="item2_1" name="item2_1" rows="2" cols="50"></textarea>
         	<p>本平台蒐集個人資料目的為：提供辦理「海外人才橋接方案」相關事宜，建立使用者與產學研機構線上/線下媒合平台，進而達成延攬高階使用者與滿足國內各機構對中高階人才的需求。</p>
			<textarea class="form-control" placeholder="輸入修改內容"  id="item2_2" name="item2_2" rows="2" cols="50"></textarea>
         	...
         	<textarea class="form-control" placeholder="輸入修改內容"  id="item2_3" name="item2_3" rows="2" cols="50"></textarea>
         	...
         	<textarea class="form-control" placeholder="輸入修改內容"  id="item2_4" name="item2_4" rows="2" cols="50"></textarea>       
			...
			<textarea class="form-control" placeholder="輸入修改內容"  id="item2_5" name="item2_5" rows="2" cols="50"></textarea>
        ...
        <h6>第三條、資料之管理與維護</h6>
          ...
          <p>自初次登錄資料後，爾後如有編修之需求，本平台提供您自行維護資料的功能。</p>
			<textarea class="form-control" placeholder="輸入修改內容"  id="item3_1" name="item3_1" rows="2" cols="50"></textarea>
          <p>除您有權管理及維護您的資料外，當您所登錄履歷/職缺資料不正確、不完整，本平台將會聯繫您，提醒您修改或補填；或者在您的同意下，協助您修改或補填履歷/職缺資料。</p>     
			<textarea class="form-control" placeholder="輸入修改內容"  id="item3_2" name="item3_2" rows="2" cols="50"></textarea>
		</div>
		<div class="col-md-12">
          <h6>第四條、 資料之保護</h6>
          <div class="line_div"></div>
          <p>為防止外人非法入侵本平台資料庫系統，本平台主機已裝設防火牆系統，並有專人負責資料庫之管理及維護工作。另外，只有經過授權的人員才能接觸您的個人資料，相關處理人員皆簽有保密合約，如有違反保密義務者，將會受到相關的法律處分。如相關單位或機構因業務需要有必要委託本平台提供服務時，本平台亦會嚴格要求其遵守保密義務，並且採取必要檢查程序以確定其將確實遵守。</p>
			<textarea class="form-control" placeholder="輸入修改內容"  id="item4_1" name="item4_1" rows="2" cols="50"></textarea>
          <p>為維護您的隱私權益及求職資料之安全，我們會竭盡最大努力，嚴格篩選徵才機構，敬請安心登錄您的履歷資料。</p>
			<textarea class="form-control" placeholder="輸入修改內容"  id="item4_2" name="item4_2" rows="2" cols="50"></textarea>
          <p>對於非善意的使用行為、未遂行為或意圖(包含但不限於：不當地獲取資料、危害網站的安全系統、有損本平台或他人權利的侵權行為)，本平台有權要求檢調機關、司法機關或行政機關協助調查，並向該行為者求償。         </p>
          	<textarea class="form-control" placeholder="輸入修改內容"  id="item4_3" name="item4_3" rows="2" cols="50"></textarea>
          <p>請妥善保管您的帳號密碼及求職資料，不要將任何資料，尤其是帳號密碼提供給任何人。在您登入系統完成各項作業後，務必記得登出帳號，並定時更換您的密碼，以防他人盜用。</p>
			<textarea class="form-control" placeholder="輸入修改內容"  id="item4_4" name="item4_4" rows="2" cols="50"></textarea>
        </div>
        <div class="col-md-12">
          <h6>第五條、隱私權保護政策之修正</h6>
          <div class="line_div"></div><span>本平台保留增刪修改本隱私權保護政策內容之權利，所有修改條款應自公告於網站上後生效，不個別通知。</span>
			<textarea class="form-control" placeholder="輸入修改內容"  id="item5_1" name="item4_4" rows="2" cols="50"></textarea>   
