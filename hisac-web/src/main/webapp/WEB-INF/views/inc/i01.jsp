...
isCERTEventProcessingSign=${isCERTEventProcessingSign}<br> -->
	...
	<div id="divEdit" class="container" ng-show="btnIns || btnUpd"  style="display:none">
		<div class="row">
			<h4 class="form_heading form_heading_fix form_heading_gray"
				ng-show="btnIns">
	...
	<div id="divReview" class="container">
		<div class="row">
			<h4 class="form_heading form_heading form_heading_yellow">
				<i class="fa fa-info-circle"></i><b><s:message code="btnReview" /></b>
			</h4>
		</div>
		<div class="row">
			<h4 class="form_heading form_heading_fix form_heading_gray"
		...
		<div class="row">
			<ul class="nav nav-tabs" id="tabIncidentQueryStep">
				<li class="active"><a data-toggle="tab"
					href="#tabIncidentQueryStep1" ng-click="gotToQueryStep(1)"
					aria-expanded="true"><s:message code="i01IncidentStep1Title" /></a></li>
				<li class=""><a data-toggle="tab" href="#tabIncidentQueryStep2"
					ng-click="gotToQueryStep(2)" aria-expanded="false"><s:message
							code="i01IncidentStep2Title" /></a></li>
				<li class=""
					ng-show="Status == 2 || Status == 3 || Status == 4 || Status == 5"><a
					data-toggle="tab" href="#tabIncidentQueryStep3"
					ng-click="gotToQueryStep(3)" aria-expanded="false"><s:message
							code="i01IncidentStep3Title" /></a></li>
				<li class="" ng-show="Status == 3 || Status == 5"><a data-toggle="tab" href="#tabIncidentQueryStep4"
					ng-click="gotToQueryStep(4)" aria-expanded="false">廠商滿意度問卷</a></li>
			</ul>
		</div>

		<form class="form-horizontal" role="form" name="myForm">
			<div class="tab-content tab_content">
				<div id="tabIncidentQueryStep1" class="tab-pane active">
					<div class="row">
						<div class="col-xs-12">
							<div class="alert alert-dismissible alert-warning form_title_bar">
								<h3>
						...
						<div class="col-xs-12">
							...
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray"><s:message
											code="i01PostId" /></label> <span>{{PostId}}</span>
								</div>
							</div>
							<div>
								<div class="form_group">
							...
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray"><s:message
											code="i01Status" /></label> <span ng-show="Status == '1'"><s:message
											code="i01StatusOpt1" /></span> <span ng-show="Status == '2'"><s:message
											code="i01StatusOpt2" /></span> <span ng-show="Status == '3'"><s:message
											code="i01StatusOpt3" /></span> <span ng-show="Status == '4'"><s:message
											code="i01StatusOpt4" /></span> <span ng-show="Status == '5'"><s:message
											code="i01StatusOpt5" /></span>
								</div>
							</div>
						</div>
					</div>
				...
				<div id="tabIncidentQueryStep2" class="tab-pane">
					<div class="row">
						<div class="col-xs-12">
							<div class="alert alert-dismissible alert-warning form_title_bar">
								<h3>
						...
						<div class="col-xs-12">
							...
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray"><s:message
											code="i01EventType" /></label> <label class="input_for_radio_group"><span><i
											class="far fa-fw fa-dot-circle" ng-show="EventType==1"></i><i
											class="far fa-fw fa-circle" ng-show="EventType!=1"></i> <s:message
												code="i01EventType1" /> </span> <span ng-show="EventType==1">(&nbsp;
											<i class="far fa-fw fa-check-square"
											...
											ng-show="!IsEventType1Opt1"></i> <s:message
												code="i01IsEventType1Opt1" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType1Opt2"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType1Opt2"></i>
											<s:message code="i01IsEventType1Opt2" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType1Opt3"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType1Opt3"></i>
											<s:message code="i01IsEventType1Opt3" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType1Opt4"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType1Opt4"></i>
											<s:message code="i01IsEventType1Opt4" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType1Opt5"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType1Opt5"></i>
											<s:message code="i01IsEventType1Opt5" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType1Opt6"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType1Opt6"></i>
											<s:message code="i01IsEventType1Opt6" /> )
									</span> </label> <label class="input_for_radio_group"><span><i
											class="far fa-fw fa-dot-circle" ng-show="EventType==2"></i><i
											class="far fa-fw fa-circle" ng-show="EventType!=2"></i> <s:message
												code="i01EventType2" /> </span> <span ng-show="EventType==2">(&nbsp;
											...
											ng-show="!IsEventType2Opt1"></i> <s:message
												code="i01IsEventType2Opt1" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType2Opt2"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType2Opt2"></i>
											<s:message code="i01IsEventType2Opt2" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType2Opt3"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType2Opt3"></i>
											<s:message code="i01IsEventType2Opt3" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType2Opt4"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType2Opt4"></i>
											<s:message code="i01IsEventType2Opt4" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType2Opt5"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType2Opt5"></i>
											<s:message code="i01IsEventType2Opt5" /> )
									</span> </label> <label class="input_for_radio_group"><span><i
											class="far fa-fw fa-dot-circle" ng-show="EventType==3"></i><i
											class="far fa-fw fa-circle" ng-show="EventType!=3"></i> <s:message
												code="i01EventType3" /> </span> <span ng-show="EventType==3">(&nbsp;
											...
											ng-show="!IsEventType3Opt1"></i> <s:message
												code="i01IsEventType3Opt1" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType3Opt2"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType3Opt2"></i>
											<s:message code="i01IsEventType3Opt2" /> )
									</span> </label> <label class="input_for_radio_group"><span><i
											class="far fa-fw fa-dot-circle" ng-show="EventType==4"></i><i
											class="far fa-fw fa-circle" ng-show="EventType!=4"></i> <s:message
												code="i01EventType4" /> </span> <span ng-show="EventType==4">(&nbsp;
											...
											ng-show="!IsEventType4Opt1"></i> <s:message
												code="i01IsEventType4Opt1" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType4Opt2"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType4Opt2"></i>
											<s:message code="i01IsEventType4Opt2" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType4Opt3"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType4Opt3"></i>
											<s:message code="i01IsEventType4Opt3" /> <i
											class="far fa-fw fa-check-square" ng-show="IsEventType4Opt4"></i><i
											class="far fa-fw fa-square" ng-show="!IsEventType4Opt4"></i>
											<s:message code="i01IsEventType4Opt4" /> )
									</span> </label> <label class="input_for_radio_group"><span><i
											class="far fa-fw fa-dot-circle" ng-show="EventType==5"></i><i
											class="far fa-fw fa-circle" ng-show="EventType!=5"></i> <s:message
												code="i01EventType5" /> <s:message
				...
				<div id="tabIncidentQueryStep3" class="tab-pane"
					ng-show="Status == 2 || Status == 3 || Status == 4 || Status == 5">
					<div class="row">
						<div class="col-xs-12">
							<div class="alert alert-dismissible alert-warning form_title_bar">
								<h3>
						...
						<div class="col-xs-12">
							...
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray"><s:message
											code="i01IsOs" /></label> <span><i
										class="far fa-fw fa-check-square" ng-show="IsOsOpt1"></i><i
										class="far fa-fw fa-square" ng-show="!IsOsOpt1"></i> <s:message
											code="i01IsOsOpt1" /> </span><span><i
										class="far fa-fw fa-check-square" ng-show="IsOsOpt2"></i><i
										class="far fa-fw fa-square" ng-show="!IsOsOpt2"></i> <s:message
											code="i01IsOsOpt2" /> </span><span><i
										class="far fa-fw fa-check-square" ng-show="IsOsOpt3"></i><i
										class="far fa-fw fa-square" ng-show="!IsOsOpt3"></i> <s:message
											code="i01IsOsOpt3" /> </span> <span ng-if="IsOsOpt3"><s:message
											code="i01IsOsOpt3Other" />{{IsOsOpt3Other}}</span>
								</div>
							</div>
								<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray"><s:message
											code="i01IsEventCause" /></label> <span><i
										class="far fa-fw fa-check-square" ng-show="IsEventCause1Opt1"></i><i
										class="far fa-fw fa-square" ng-show="!IsEventCause1Opt1"></i>
										<s:message code="i01IsEventCause1Opt1" /> </span><span><i
										class="far fa-fw fa-check-square" ng-show="IsEventCause1Opt2"></i><i
										class="far fa-fw fa-square" ng-show="!IsEventCause1Opt2"></i>
										<s:message code="i01IsEventCause1Opt2" /> </span><span><i
										class="far fa-fw fa-check-square" ng-show="IsEventCause1Opt3"></i><i
										class="far fa-fw fa-square" ng-show="!IsEventCause1Opt3"></i>
										<s:message code="i01IsEventCause1Opt3" /> </span><span><i
										class="far fa-fw fa-check-square" ng-show="IsEventCause1Opt4"></i><i
										class="far fa-fw fa-square" ng-show="!IsEventCause1Opt4"></i>
										<s:message code="i01IsEventCause1Opt4" /> </span><span><i
										class="far fa-fw fa-check-square" ng-show="IsEventCause1Opt5"></i><i
										class="far fa-fw fa-square" ng-show="!IsEventCause1Opt5"></i>
										<s:message code="i01IsEventCause1Opt5" /> </span><span><i
										class="far fa-fw fa-check-square" ng-show="IsEventCause1Opt6"></i><i
										class="far fa-fw fa-square" ng-show="!IsEventCause1Opt6"></i>
										<s:message code="i01IsEventCause1Opt6" /> </span> <span
										ng-if="IsEventCause1Opt6"><s:message
											code="i01IsEventCause1Opt6Other" />{{IsEventCause1Opt6Other}}</span>
								</div>
							</div>
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray"><s:message
											code="i01EventEvaluation" /></label><span
										class="form-text form_text form_input_search">{{EventEvaluation}}</span>
								</div>
							</div>
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray"><s:message
											code="i01EventProcess" /></label><span
										class="form-text form_text form_input_search">{{EventProcess}}</span>
								</div>
							</div>
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray"><s:message
											code="i01IsSecuritySetting" /></label> <label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt1"></i><i
											class="far fa-fw fa-square" ng-show="!IsSecuritySetting1Opt1"></i>
											<s:message code="i01IsSecuritySetting1Opt1" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt2"></i><i
											class="far fa-fw fa-square" ng-show="!IsSecuritySetting1Opt2"></i>
											<s:message code="i01IsSecuritySetting1Opt2" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt3"></i><i
											class="far fa-fw fa-square" ng-show="!IsSecuritySetting1Opt3"></i>
											<s:message code="i01IsSecuritySetting1Opt3" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt4"></i><i
											class="far fa-fw fa-square" ng-show="!IsSecuritySetting1Opt4"></i>
											<s:message code="i01IsSecuritySetting1Opt4" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt5"></i><i
											class="far fa-fw fa-square" ng-show="!IsSecuritySetting1Opt5"></i>
											<s:message code="i01IsSecuritySetting1Opt5" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt6"></i><i
											class="far fa-fw fa-square" ng-show="!IsSecuritySetting1Opt6"></i>
											<s:message code="i01IsSecuritySetting1Opt6" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt7"></i><i
											class="far fa-fw fa-square" ng-show="!IsSecuritySetting1Opt7"></i>
											<s:message code="i01IsSecuritySetting1Opt7" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt8"></i><i
											class="far fa-fw fa-square" ng-show="!IsSecuritySetting1Opt8"></i>
											<s:message code="i01IsSecuritySetting1Opt8" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt9"></i><i
											class="far fa-fw fa-square" ng-show="!IsSecuritySetting1Opt9"></i>
											<s:message code="i01IsSecuritySetting1Opt9" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt10"></i><i
											class="far fa-fw fa-square"
											ng-show="!IsSecuritySetting1Opt10"></i> <s:message
												code="i01IsSecuritySetting1Opt10" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt11"></i><i
											class="far fa-fw fa-square"
											ng-show="!IsSecuritySetting1Opt11"></i> <s:message
												code="i01IsSecuritySetting1Opt11" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt12"></i><i
											class="far fa-fw fa-square"
											ng-show="!IsSecuritySetting1Opt12"></i> <s:message
												code="i01IsSecuritySetting1Opt12" /> </span></label><label
										class="input_for_radio_group"><span><i
											class="far fa-fw fa-check-square"
											ng-show="IsSecuritySetting1Opt13"></i><i
											class="far fa-fw fa-square"
											ng-show="!IsSecuritySetting1Opt13"></i> <s:message
												code="i01IsSecuritySetting1Opt13" /> </span></label>
								</div>
							</div>
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray"><s:message
											code="i01FinishDoOther" /></label><span
							...
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray"><s:message
											code="i01FinishDateTime" /></label><span
										class="form-text form_text form_input_search">{{FinishDateTime}}</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div id="tabIncidentQueryStep4" class="tab-pane">					
					<div class="row" ng-show="(Status == 3 || Status == 5) && SubStatus==31 && ${orgId} == ReporterName">
						<div class="col-xs-12">
							<div class="alert alert-dismissible alert-warning form_title_bar">
								<h3>
									<b>廠商滿意度問卷</b>
						...
						<div class="col-xs-12">							
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray">請問對於事件處理時程掌握的滿意度</label>
									<span> <input type="radio"
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTime==0 || SatisfactionTime==null)" 
									id="SatisfactionTime1" name="SatisfactionTime" ng-model="SatisfactionTime" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=1><label for="SatisfactionTime1" class="label_for_radio">極不滿意 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTime==0 || SatisfactionTime==null)" 
									id="SatisfactionTime2" name="SatisfactionTime" ng-model="SatisfactionTime" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=2><label for="SatisfactionTime2" class="label_for_radio">不滿意 </label>
									</span>								
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTime==0 || SatisfactionTime==null)" 
									id="SatisfactionTime3" name="SatisfactionTime" ng-model="SatisfactionTime" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=3><label for="SatisfactionTime3" class="label_for_radio">普通 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTime==0 || SatisfactionTime==null)" 
									id="SatisfactionTime4" name="SatisfactionTime" ng-model="SatisfactionTime" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=4><label for="SatisfactionTime4" class="label_for_radio">滿意 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTime==0 || SatisfactionTime==null)" 
									id="SatisfactionTime5" name="SatisfactionTime" ng-model="SatisfactionTime" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=5><label for="SatisfactionTime5" class="label_for_radio">非常滿意 </label>
									</span>									
									<h5 class="text-danger"
									ng-show="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTime==0 || SatisfactionTime==null)">
									<s:message code="pleaseEnter" />
									對於事件處理時程掌握的滿意度
									</h5>															
								</div>
							...
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray">請問對於廠商的專業性滿意度</label>
									<span> <input type="radio"
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionProfessionalism==0 || SatisfactionProfessionalism==null)" 
									id="SatisfactionProfessionalism1" name="SatisfactionProfessionalism" ng-model="SatisfactionProfessionalism" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=1><label for="SatisfactionProfessionalism1" class="label_for_radio">極不滿意 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionProfessionalism==0 || SatisfactionProfessionalism==null)" 
									id="SatisfactionProfessionalism2" name="SatisfactionProfessionalism" ng-model="SatisfactionProfessionalism" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=2><label for="SatisfactionProfessionalism2" class="label_for_radio">不滿意 </label>
									</span>								
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionProfessionalism==0 || SatisfactionProfessionalism==null)" 
									id="SatisfactionProfessionalism3" name="SatisfactionProfessionalism" ng-model="SatisfactionProfessionalism" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=3><label for="SatisfactionProfessionalism3" class="label_for_radio">普通 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionProfessionalism==0 || SatisfactionProfessionalism==null)" 
									id="SatisfactionProfessionalism4" name="SatisfactionProfessionalism" ng-model="SatisfactionProfessionalism" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=4><label for="SatisfactionProfessionalism4" class="label_for_radio">滿意 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionProfessionalism==0 || SatisfactionProfessionalism==null)" 
									id="SatisfactionProfessionalism5" name="SatisfactionProfessionalism" ng-model="SatisfactionProfessionalism" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=5><label for="SatisfactionProfessionalism5" class="label_for_radio">非常滿意 </label>
									</span>									
									<h5 class="text-danger"
									ng-show="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionProfessionalism==0 || SatisfactionProfessionalism==null)">
									<s:message code="pleaseEnter" />
									對於廠商的專業性滿意度
									</h5>															
								</div>
							...
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray">請問對於廠商服務態度滿意度</label>
									<span> <input type="radio"
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionService==0 || SatisfactionService==null)" 
									id="SatisfactionService1" name="SatisfactionService" ng-model="SatisfactionService" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=1><label for="SatisfactionService1" class="label_for_radio">極不滿意 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionService==0 || SatisfactionService==null)" 
									id="SatisfactionService2" name="SatisfactionService" ng-model="SatisfactionService" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=2><label for="SatisfactionService2" class="label_for_radio">不滿意 </label>
									</span>								
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionService==0 || SatisfactionService==null)" 
									id="SatisfactionService3" name="SatisfactionService" ng-model="SatisfactionService" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=3><label for="SatisfactionService3" class="label_for_radio">普通 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionService==0 || SatisfactionService==null)" 
									id="SatisfactionService4" name="SatisfactionService" ng-model="SatisfactionService" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=4><label for="SatisfactionService4" class="label_for_radio">滿意 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionService==0 || SatisfactionService==null)" 
									id="SatisfactionService5" name="SatisfactionService" ng-model="SatisfactionService" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=5><label for="SatisfactionService5" class="label_for_radio">非常滿意 </label>
									</span>									
									<h5 class="text-danger"
									ng-show="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionService==0 || SatisfactionService==null)">
									<s:message code="pleaseEnter" />
									對於廠商服務態度滿意度
									</h5>															
								</div>
							...
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray">請問對於廠商提供之事件調查處理及改善建議報告滿意度</label>
									<span> <input type="radio"
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionReport==0 || SatisfactionReport==null)" 
									id="SatisfactionReport1" name="SatisfactionReport" ng-model="SatisfactionReport" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=1><label for="SatisfactionReport1" class="label_for_radio">極不滿意 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionReport==0 || SatisfactionReport==null)" 
									id="SatisfactionReport2" name="SatisfactionReport" ng-model="SatisfactionReport" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=2><label for="SatisfactionReport2" class="label_for_radio">不滿意 </label>
									</span>								
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionReport==0 || SatisfactionReport==null)" 
									id="SatisfactionReport3" name="SatisfactionReport" ng-model="SatisfactionReport" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=3><label for="SatisfactionReport3" class="label_for_radio">普通 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionReport==0 || SatisfactionReport==null)" 
									id="SatisfactionReport4" name="SatisfactionReport" ng-model="SatisfactionReport" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=4><label for="SatisfactionReport4" class="label_for_radio">滿意 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionReport==0 || SatisfactionReport==null)" 
									id="SatisfactionReport5" name="SatisfactionReport" ng-model="SatisfactionReport" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=5><label for="SatisfactionReport5" class="label_for_radio">非常滿意 </label>
									</span>									
									<h5 class="text-danger"
									ng-show="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionReport==0 || SatisfactionReport==null)">
									<s:message code="pleaseEnter" />
									對於廠商提供之事件調查處理及改善建議報告滿意度
									</h5>															
								</div>
							</div>
							...
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray">請問對於事件處理整體品質滿意度</label>
									<span> <input type="radio"
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTotal==0 || SatisfactionTotal==null)" 
									id="SatisfactionTotal1" name="SatisfactionTotal" ng-model="SatisfactionTotal" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=1><label for="SatisfactionTotal1" class="label_for_radio">極不滿意 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTotal==0 || SatisfactionTotal==null)" 
									id="SatisfactionTotal2" name="SatisfactionTotal" ng-model="SatisfactionTotal" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=2><label for="SatisfactionTotal2" class="label_for_radio">不滿意 </label>
									</span>								
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTotal==0 || SatisfactionTotal==null)" 
									id="SatisfactionTotal3" name="SatisfactionTotal" ng-model="SatisfactionTotal" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=3><label for="SatisfactionTotal3" class="label_for_radio">普通 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTotal==0 || SatisfactionTotal==null)" 
									id="SatisfactionTotal4" name="SatisfactionTotal" ng-model="SatisfactionTotal" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=4><label for="SatisfactionTotal4" class="label_for_radio">滿意 </label>
									</span>
									<span> <input type="radio" 
									ng-required="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTotal==0 || SatisfactionTotal==null)" 
									id="SatisfactionTotal5" name="SatisfactionTotal" ng-model="SatisfactionTotal" class="ng-pristine ng-untouched ng-valid ng-not-empty" value=5><label for="SatisfactionTotal5" class="label_for_radio">非常滿意 </label>
									</span>									
									<h5 class="text-danger"
									ng-show="(Status == 3 || Status == 5) && SubStatus==31 && (SatisfactionTotal==0 || SatisfactionTotal==null)">
									<s:message code="pleaseEnter" />
									對於事件處理整體品質滿意度
									</h5>															
								</div>
							...
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray">其他建議事項</label>
									<span> 
									<textarea style="width:400px;" rows="5" autocomplete="off" id="SatisfactionRemark" name="SatisfactionRemark" ng-model="SatisfactionRemark"></textarea>
									</span>																							
								</div>
							</div>
				...
				<!-- 廠商滿意度問卷 VIEW START-->
					...
					<div class="row" ng-show="(Status == 3 || Status == 5) && (SubStatus!=31 || ${orgId} != ReporterName)">
						...
						<div class="col-xs-12">							
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray">對於事件處理時程掌握的滿意度</label> 
									<span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionTime==1"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionTime!=1"></i> 極不滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionTime==2"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionTime!=2"></i> 不滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionTime==3"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionTime!=3"></i> 普通 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionTime==4"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionTime!=4"></i> 滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionTime==5"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionTime!=5"></i> 非常滿意 </span>
								</div>
							</div>
							
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray">對於廠商的專業性滿意度</label> 
									<span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionProfessionalism==1"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionProfessionalism!=1"></i> 極不滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionProfessionalism==2"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionProfessionalism!=2"></i> 不滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionProfessionalism==3"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionProfessionalism!=3"></i> 普通 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionProfessionalism==4"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionProfessionalism!=4"></i> 滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionProfessionalism==5"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionProfessionalism!=5"></i> 非常滿意 </span>
								</div>
							</div>
							
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray">對於廠商服務態度滿意度</label> 
									<span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionService==1"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionService!=1"></i> 極不滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionService==2"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionService!=2"></i> 不滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionService==3"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionService!=3"></i> 普通 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionService==4"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionService!=4"></i> 滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionService==5"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionService!=5"></i> 非常滿意 </span>
								</div>
							</div>
							
							<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray">對於廠商提供之事件調查處理及改善建議報告滿意度</label> 
									<span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionReport==1"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionReport!=1"></i> 極不滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionReport==2"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionReport!=2"></i> 不滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionReport==3"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionReport!=3"></i> 普通 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionReport==4"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionReport!=4"></i> 滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionReport==5"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionReport!=5"></i> 非常滿意 </span>
								</div>
							</div>
							
								<div>
								<div class="form_group">
									<label class="form_label form_label_search form_label_gray">對於事件處理整體品質滿意度</label> 
									<span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionTotal==1"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionTotal!=1"></i> 極不滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionTotal==2"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionTotal!=2"></i> 不滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionTotal==3"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionTotal!=3"></i> 普通 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionTotal==4"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionTotal!=4"></i> 滿意 </span> <span><i
										class="far fa-fw fa-dot-circle" ng-show="SatisfactionTotal==5"></i><i
										class="far fa-fw fa-circle" ng-show="SatisfactionTotal!=5"></i> 非常滿意 </span>
								</div>
							</div>
						...
						<table
							...
							<tbody>
								<tr ng-repeat="item in MessageProcessLogData">
									<td><span ng-if="item.PreStatus == 1"><s:message code="i01ShowPreStatus1" /></span> 
										<span ng-if="item.PreStatus == 2"><s:message code="i01ShowPreStatus2" /></span> 
										<span ng-if="item.PreStatus == 3"><s:message code="i01ShowPreStatus3" /></span> 
										<span ng-if="item.PreStatus == 4"><s:message code="i01ShowPreStatus2" /></span>
										<span><i class="fas fa-fw fa-arrow-right"></i></span> 
										<span ng-if="item.Status == 2"><s:message code="i01ShowStatus2" /></span> 
										<span ng-if="item.Status == 3"><s:message code="i01ShowStatus3" /></span>
										<span ng-if="item.Status == 4"><s:message code="i01ShowStatus2" /></span> 
										<span ng-if="item.Status == 5"><s:message code="i01ShowStatus5" /></span>
									</td>
									<td><span ng-if="item.Status == 1"><s:message code="i01Status1" /></span> 
										<span ng-if="item.Status == 2"><s:message code="i01Status2" /></span> 
										<span ng-if="item.Status == 3"><s:message code="i01Status3" /></span> 
										<span ng-if="item.Status == 4"><s:message code="i01Status4" /></span> 
										<span ng-if="item.Status == 5"><s:message code="i01Status5" /></span>
									</td>
				...
				<div ng-show="IsSeeOpinion && Status == 3">
					...
					<div class="form_group">
						...
						<div class="form_input form_input_search">
							<textarea id="Opinion" name="Opinion" ng-model="Opinion" rows="5"
				...
				<div class="page-header">
					<div>
						<div class="clearfix form-actions">
							<div class="text-center">
								<button ng-hide="!queryStepPrev"
									class="btn btn-primary pull-left"
									ng-click="gotToQueryStep(queryStep - 1)">
									<i class="fas fa-fw fa-step-backward"></i>
									<s:message code="globalStepPrev" />
								</button>
								<button ng-hide="!queryStepNext"
								...
								<button class="btn btn_custom btn_blue"
									ng-disabled="!myForm.$valid" ng-click="examine(Id, '5')"
									ng-show="messagePassButton">
									<i class="fas fa-fw fa-check"></i>
									<s:message code="btnPass" />
								</button>
								<button class="btn btn_custom btn_blue"
									ng-disabled="Opinion==null || Opinion==''" ng-click="examine(Id, '4')"
