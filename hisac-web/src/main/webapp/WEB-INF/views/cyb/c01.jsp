				...
				<table
					...
					<tbody>
						<tr ng-repeat="item in allitems">
							...
							<td>{{ ('' + item.Status).indexOf(1)!=-1?"編輯中":"" }} {{ ('' + item.Status).indexOf(2)!=-1?"撤銷中":""
								}} {{ ('' + item.Status).indexOf(3)!=-1?"審核中":"" }} {{ ('' + item.Status).indexOf(4)!=-1?"已轉公開資訊":""
								}} {{ ('' + item.Status).indexOf(5)!=-1?"已轉警訊":"" }} {{
								('' + item.Status).indexOf(6)!=-1?"已轉N-ISAC":"" }} {{ ('' + item.Status).indexOf(7)!=-1?"已銷案":"" }} {{
								('' + item.Status).indexOf(8)!=-1?"編輯中(退回)":"" }}</td>
					...
					<div>
								...
								<table
									...
									<tbody>
										<tr ng-repeat="item in reviewData.InformationExchangeLog">
											<td><span ng-if="('' + item.PreStatus).indexOf(1)!=-1">新增情資</span> <span
													ng-if="('' + item.PreStatus).indexOf(2)!=-1">情資撤銷</span> <span
													ng-if="('' + item.PreStatus).indexOf(3)!=-1">情資審核</span> <span
													ng-if="('' + item.PreStatus).indexOf(4)!=-1">情資轉公開訊息</span><span
													ng-if="('' + item.PreStatus).indexOf(5)!=-1">情資轉警訊</span><span
													ng-if="('' + item.PreStatus).indexOf(6)!=-1">情資轉NISAC</span><span
													ng-if="('' + item.PreStatus).indexOf(7)!=-1">情資已銷案</span><span
													ng-if="('' + item.PreStatus).indexOf(8)!=-1">情資已退回</span> <span><i
														class="fas fa-fw fa-arrow-right"></i></span> <span
													ng-if="('' + item.Status).indexOf(2)!=-1">情資撤銷</span> <span
													ng-if="('' + item.Status).indexOf(3)!=-1">情資審核</span> <span
													ng-if="('' + item.Status).indexOf(4)!=-1">情資轉公開訊息</span> <span
													ng-if="('' + item.Status).indexOf(5)!=-1">情資轉警訊</span> <span
													ng-if="('' + item.Status).indexOf(6)!=-1">情資轉NISAC</span> <span
													ng-if="('' + item.Status).indexOf(7)!=-1">情資已銷案</span><span
													ng-if="('' + item.Status).indexOf(8)!=-1">情資已退回</span></td>
												<td><span ng-if="('' + item.Status).indexOf(1)!=-1">新增情資
															</span> <span ng-if="('' + item.Status).indexOf(2)!=-1">情資撤銷
															</span> <span ng-if="('' + item.Status).indexOf(3)!=-1">情資審核
															</span> <span ng-if="('' + item.Status).indexOf(4)!=-1">情資轉公開訊息
															</span> <span ng-if="('' + item.Status).indexOf(5)!=-1">情資轉警訊
															</span> <span ng-if="('' + item.Status).indexOf(6)!=-1">情資轉NISAC
															</span> <span ng-if="('' + item.Status).indexOf(7)!=-1">情資已銷案
															</span> <span ng-if="('' + item.Status).indexOf(8)!=-1">情資已退回
															</span> </td>
						...
						<div class="submit_bar">
							<button class="btn btn_custom btn_blue"
								...
								ng-show="('' + reviewData.Status).indexOf(3)!=-1"
							...
							<button class="btn btn_custom btn_blue"
								ng-disabled="Opinion == null"
								ng-hide="('' + reviewData.Status).indexOf(4)!=-1 || ('' + reviewData.Status).indexOf(5)!=-1"
							...
							<button class="btn btn_custom btn_blue"
								ng-disabled="Opinion == null"
								ng-hide="('' + reviewData.Status).indexOf(5)!=-1 || ('' + reviewData.Status).indexOf(4)!=-1"
							...
							<button class="btn btn_custom btn_blue"
								ng-disabled="Opinion == null"
								ng-hide="('' + reviewData.Status).indexOf(6)!=-1"
						...
						<div id="tabAlert" class="tab-pane active">
							...
							<div>
								<div class="form_group">
									...
									ng-model="SourceCode" class="form-control"
									ng-options="SourceCode.Code as SourceCode.Code+':'+SourceCode.Name  for  SourceCode in SourceCodes">									
								</select>
									</div>
								</div>
