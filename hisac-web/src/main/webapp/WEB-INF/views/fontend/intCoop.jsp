            ...
            <div class="row">
              <div class="col-md-3 col-sm-12">
                <div class="video_outer">
          			<img src="<c:out value="${pageContext.request.contextPath}" />/resources/img/video2.jpg" alt="">
	                <a href="https://www.youtube.com/embed/oj_pWOCisJ4"></a>
                </div>
              </div>
              ...
              <div class="col-md-2 col-sm-12 wordad">
