...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/about.js"></script>
		...
		<div class="row detail_block" ng-show="itemAttachments.length > 0">
			...
			<ul class="detailAttachFile">
				<li ng-repeat="item in itemAttachments"><s:message
					...
					ng-href="<c:out value="${pageContext.request.contextPath}" />/public/api/about/attach/download/{{id}}/{{item.Id}}"
