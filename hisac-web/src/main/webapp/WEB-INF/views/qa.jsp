...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/qa.js"></script>
			...
			<div class="row">
				<div class="table-responsive">
					<table
						...
						<thead>
							<tr>
								<th><s:message code="p01QAManagementGroup" /></th>
								<th><s:message code="p01QAManagementName" /></th>															    
							</tr>
						</thead>
						<tbody>
			...
			<div class="row detail_block" ng-show="itemAttachments.length > 0">
				...
				<ul class="detailAttachFile">
					<li ng-repeat="item in itemAttachments"><s:message
						...
						ng-href="<c:out value="${pageContext.request.contextPath}" />/public/api/qa/attach/download/{{id}}/{{item.Id}}"
