...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/mtp/m02.js"></script>
		...
		<div class="row">
			<div class="table-responsive">
				<table
					...
					<thead>
						<tr>
							<th><a href="" ng-click="setSortName('id')"> 資安維護計畫群組編號 <i ng-show="sorttype != 'id'"
							...
							<th><a href="" ng-click="setSortName('name')"> 資安維護計畫群組名稱 <i ng-show="sorttype != 'name'"
									class="fas fa-fw fa-sort text-muted"></i><i
			...
			<div class="col-xs-12 shadow_board">
				<form name="editForm">
					...
					<div>
						<div class="form_group">
							<label for="Name"
								class="form_label form_label_search form_label_gray">資安維護計畫群組名稱</label>
							<div class="form_input form_input_search">
