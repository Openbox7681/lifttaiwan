...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/mtp/m04.js"></script>
<script
	...
	<div id="divQuery" class="container">
		...
		<div class="row">
			...
			<button class="btn btn-success" ng-click="importFileCheckList()"
				...
				<i class="fas fa-sync fa-spin"></i> 匯入資通安全實地稽核項目檢核表格式
			</button>
		</div>
		...
		<div class="row">
			...
			<button class="btn btn-success" ng-click="importFileQuestionnaire()"
				...
				<i class="fas fa-sync fa-spin"></i> 匯入受稽機關現況調查表格式
			</button>
		</div>
	</div>
