...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/pub/p13.js"></script>
<body class="no-skin" ng-controller="getAppController">
	...
	<div class="col-xs-12 col-md-3 no_padding">
		...
		<div id="divSlide" style="display: none" class="col-xs-12 col-md-9 no_padding">
			<h4>
			<a style = "color :#e34227 ; font-weight:bold;"
			href="#" ng-click="queryDetailData(5)"
			>
			...
			<div class="row">
				<div class="table-responsive">
					<table
						...
						<thead>
							<tr>
								<th class="col-xs-2"><s:message code="malwarePostDateTime" /></th>
								<th class="col-xs-3" ><s:message code="malwareTitle" /></th>
		...
		<div id="divDetail" style="display: none">
			<div class="row detail_block">				
				...
				<h5 class="detailSource">
					<span><s:message code="malwareSoruce" />&nbsp;:&nbsp;{{detailSourceName}}</span>
					<span class="pull-right"><s:message code="malwarePostDateTime" />&nbsp;:&nbsp;{{detailPostDataTime}}</span>
				</h5>
				...
				<h5 class="detailSource" ng-if="detailSourceLink != null && detailSourceLink != ''">
					<span><s:message code="s45SourceLink" />&nbsp;:&nbsp;</span><a ng-href="{{detailSourceLink}}" target="_news">{{detailSourceLink}}</a>
				</h5>	
			</div>		
			<div class="row detail_block" ng-show="itemAttachments.length > 0">
				...
				<ul class="detailAttachFile">
					<li ng-repeat="item in itemAttachments"><s:message
						...
						ng-href="<c:out value="${pageContext.request.contextPath}" />/pub/api/p13/attach/download/{{id}}/{{item.Id}}"
