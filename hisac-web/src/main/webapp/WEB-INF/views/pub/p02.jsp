					...
					<table
						...
						<tbody>
							<tr ng-repeat="item in allitems">
								...
								<td class="text-center">{{item.StartDateTime}}<s:message code="globalDataFromTo" />{{item.EndDateTime}}</td>
		...
		<div id="divDetail" style="display: none">
			<div class="row detail_block">				
				...
				<h5 class="detailSource">
					...
					<span class="pull-right"><s:message code="activityPostDateTime" />&nbsp;:&nbsp;{{detailPostDataTime}}</span>
				</h5>
			...
			<div class="row detail_block" ng-show="itemAttachments.length > 0">
				...
				<ul class="detailAttachFile">
					<li ng-repeat="item in itemAttachments"><s:message
						...
						ng-href="<c:out value="${pageContext.request.contextPath}" />/pub/api/p02/attach/download/{{id}}/{{item.Id}}"
