		...
		<div id="divQuery" style="display: none">
			...
			<div class="row">
				<div class="col-xs-12 col-md-6 no_padding">
					...
					<div class="col-xs-12 col-md-6 no_padding">				
					<a class="btn btn_custom btn_green pull-right" type="button"
						href="${pageContext.request.contextPath}/sys/s42"> <i class="fas fa-fw fa-plus-circle"></i>
		...
		<div id="divDetail" style="display: none">
			<div class="row detail_block">				
				...
				<h5 class="detailSource">
					<span>資料來源&nbsp;:&nbsp;{{detailSourceName}}</span>
					<span class="pull-right">日期&nbsp;:&nbsp;{{detailPostDataTime}}</span>
				</h5>
				...
				<h5 class="detailSource" ng-if="detailSourceLink != null && detailSourceLink != ''">
					<span><s:message code="s31SourceLink" />&nbsp;:&nbsp;</span><a ng-href="{{detailSourceLink}}">{{detailSourceLink}}</a>
				</h5>
			</div>
			<div class="row detail_block" ng-show="itemAttachments.length > 0">
				...
				<ul class="detailAttachFile">
					<li ng-repeat="item in itemAttachments"><s:message
						...
						ng-href="<c:out value="${pageContext.request.contextPath}" />/pub/api/p12/attach/download/{{id}}/{{item.Id}}"
