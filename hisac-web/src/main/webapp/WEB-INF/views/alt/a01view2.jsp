...
<div id="divView" class="container" ng-if="View_Show">
	...
	<div class="row">
		<ul class="nav nav-tabs" id="tabNotifyQueryStep">
			...
			<li class=""
				ng-show="Status==4 || Status==9 || Status==51 || Status==52 || Status==53 || Status==6"><a
				data-toggle="tab" href="#tabNotifyQueryStep5"
		...
		<div class="tab-content tab_content">
				...
				<table
					...
					<thead>
						<tr>						
							...
							<th width="20%"><a href="" ng-click="setSortName('name')">
									<span>
									設備名稱
									</span> 
							</a></th>
			...
			<div id="tabNotifyQueryStep3" class="tab-pane">
				<div class="row">
					...
					<div class="col-xs-12" ng-show="IsSeeOpinion">
			...
			<div id="tabNotifyQueryStep5" class="tab-pane"
				...
				<div class="row" ng-show="EventType==1">
					<div class="col-xs-12">
						<div class="alert alert-dismissible alert-warning form_title_bar">
							<h3>
								<b><s:message code="notifyStep5TitleDetail" />(<s:message
						...
						<div>
							<div class="form_group">
								<label class="form_label form_label_search form_label_gray"><s:message
									...
									class="form_input_search"> <i
										class="far fa-fw fa-check-square" ng-show="IsRes1LogOpt5"></i><i
										class="far fa-fw fa-square" ng-show="!IsRes1LogOpt5"></i> <s:message
											code="notifyIsRes1LogOpt5" />
								</span> <!-- Res 1 opt 5 Start --> <span>(&nbsp;<label
										class="label_for_radio" ng-if="Res1LogOpt5==1"><s:message
												code="notifyRes1LogOpt51" /></label><label class="label_for_radio"
										ng-if="Res1LogOpt5==2"><s:message
												code="notifyRes1LogOpt52" /></label><label class="label_for_radio"
										ng-if="Res1LogOpt5==3"><s:message
												code="notifyRes1LogOpt53" /></label><label class="label_for_radio"
										ng-if="Res1LogOpt5==4"><s:message
												code="notifyRes1LogOpt54" />&nbsp;&nbsp;{{Res1LogOpt5Other}}</label>)
								</span> <!-- Res 1 opt 5 End --></label> <label class="input_for_radio_group"><span
									class="form_input_search"> <i
								...
								<label class="form_label form_label_search form_label_gray"><s:message
									...
									class="form_input_search"> <i
										...
										class="far fa-fw fa-square" ng-show="!IsRes1EvaOpt6"></i> <s:message
											code="notifyIsRes1EvaOpt6" />{{Res1EvaOpt6Remark}}
								...
								<label class="form_label form_label_search form_label_gray"><s:message
									...
									class="form_input_search"> <i
										...
										class="far fa-fw fa-square" ng-show="!IsRes1DoOpt1"></i> <s:message
											...
											code="notifyIsRes1DoOpt1Unit" />{{Res1DoOpt2Remark}}
								</span> </label> <label class="input_for_radio_group"><span
									class="form_input_search"> <i
								...
								<label class="form_label form_label_search form_label_gray"><s:message
									...
									class="form_input_search"> <i
										...
										class="far fa-fw fa-square" ng-show="!IsRes2DoOpt1"></i> <s:message
											code="notifyIsRes2DoOpt1" />{{Res2DoOpt1Amount}}<s:message
											code="notifyIsRes2DoOpt1Unit" />{{Res2DoOpt1Remark}}
								</span> </label> <label class="input_for_radio_group"><span
									class="form_input_search"> <i
									...
									class="form_input_search"> <i
										...
										class="far fa-fw fa-square" ng-show="!IsRes2DoOpt5"></i> <s:message
											code="notifyIsRes2DoOpt5" />{{Res2DoOpt5Date}}
								</span></label> <label class="input_for_radio_group"><span
									class="form_input_search"> <i
							...
							<div class="form_group">
								<label class="form_label form_label_search form_label_gray"><s:message
									...
									class="form_input_search"> <i
										...
										class="label_for_radio" ng-show="Res3LogOpt3==1"><s:message
												code="notifyRes3LogOpt31" /></label><label class="label_for_radio"
										ng-show="Res3LogOpt2==2"><s:message
												code="notifyRes3LogOpt32" /></label><label class="label_for_radio"
										ng-show="Res3LogOpt2==3"><s:message
												code="notifyRes3LogOpt33" /></label>)
								</span> <!-- Res 2 opt 3 End --></label> <label class="input_for_radio_group"><span
									class="form_input_search"> <i
						...
						<div>
							<div class="form_group">
								<label class="form_label form_label_search form_label_gray"><s:message
									...
									class="form_input_search"> <i
										class="far fa-fw fa-check-square" ng-show="IsRes4EvaOpt3"></i><i
										class="far fa-fw fa-square" ng-show="!IsRes4EvaOpt3"></i> <s:message
											code="notifyIsRes4EvaOpt3" />{{Res4EvaOpt3Remark}}
								</span> </label>
							</div>
						</div>
						<div>
							<div class="form_group">
								<label class="form_label form_label_search form_label_gray"><s:message
									...
									class="form_input_search"> <i
										class="far fa-fw fa-check-square" ng-show="IsRes4DoOpt4"></i><i
										class="far fa-fw fa-square" ng-show="!IsRes4DoOpt4"></i> <s:message
											code="notifyIsRes4DoOpt4" />
								</span> </label><label class="input_for_radio_group"><span
									class="form_input_search"> <i
								...
								<label class="form_label form_label_search form_label_gray"><s:message
									...
									class="form_input_search"> <i
										...
										class="far fa-fw fa-square" ng-show="!IsRes5DoOpt1"></i> <s:message
											code="notifyIsRes5DoOpt1" />{{Res5DoOpt1Amount}}<s:message
											code="notifyIsRes5DoOpt1Unit" />{{Res5DoOpt1Remark}}
								</span> </label> <label class="input_for_radio_group"><span
									class="form_input_search"> <i
				...
				<div class="row">
					<div class="col-xs-12">
						<div>
							<div class="form_group">
								<label class="form_label form_label_search form_label_gray"><s:message
										code="notifyIsResTitleAll" /></label><label
									class="input_for_radio_group"><span
									class="form_input_search"> <s:message
											code="notifyResDescription" /><br />{{ResDescription}}
								</span> </label> <label class="input_for_radio_group"> <span> <i
										class="far fa-fw fa-dot-circle" ng-show="ResResult==1"></i><i
										class="far fa-fw fa-circle" ng-show="!(ResResult==1)"></i> <s:message
											code="notifyResResult1" /> <br /> <i
										class="far fa-fw fa-dot-circle" ng-show="ResResult==2"></i><i
										class="far fa-fw fa-circle" ng-show="!(ResResult==2)"></i> <s:message
											code="notifyResResult2" />
								</span>
								</label> <label class="input_for_radio_group"><span
									class="form_input_search"> <s:message
											code="notifyResControlTime" />{{ResControlTime}}
								</span> </label>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-xs-12">
						<div>
							<div class="form_group">
								<label class="form_label form_label_search form_label_gray">是否需要支援</label><span
									class="form-text form_text form_input_search"
									ng-if="IsHandledByMyself"><s:message
										code="notifyIsNeedSupportTrue" /></span><span
									class="form-text form_text form_input_search"
									ng-if="!IsHandledByMyself"><s:message
										code="notifyIsNeedSupportFalse" /></span>
						...
						<div ng-show="IsHandledByMyself">
							<div class="form_group">
								<label class="form_label form_label_search form_label_gray">支援廠商</label><span
									class="form-text form_text form_input_search">{{HandleCompany}}</span>
							</div>
						</div>						
					</div>
				</div>
			...
			<div id="tabNotifyQueryStep6" class="tab-pane"
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="alert alert-dismissible alert-warning form_title_bar">
							<h3 ng-show="EventType==1">
								<b><s:message code="notifyStep6TitleDetail" />(<s:message
										code="notifyEventType1" />)</b>
							</h3>
							<h3 ng-show="EventType==2">
								<b><s:message code="notifyStep6TitleDetail" />(<s:message
										code="notifyEventType2" />)</b>
							</h3>
							<h3 ng-show="EventType==3">
								<b><s:message code="notifyStep6TitleDetail" />(<s:message
										code="notifyEventType3" />)</b>
							</h3>
							<h3 ng-show="EventType==4">
								<b><s:message code="notifyStep6TitleDetail" />(<s:message
										code="notifyEventType4" />)</b>
							</h3>
							<h3 ng-show="EventType==5">
								<b><s:message code="notifyStep6TitleDetail" />(<s:message
										code="notifyEventType5" />)</b>
							</h3>
						</div>
							...
							<div class="form_group">
								<label class="form_label form_label_search form_label_gray"><s:message
									...
									class="far fa-fw fa-circle" ng-show="Finish1Reason!=6"></i> <s:message
										code="notifyFinish1Reason6" /> </span><span><i
									class="far fa-fw fa-dot-circle" ng-show="Finish1Reason==7"></i><i
									class="far fa-fw fa-circle" ng-show="Finish1Reason!=7"></i> <s:message
										code="notifyFinish1Reason7" /> </span><span><i
									class="far fa-fw fa-dot-circle" ng-show="Finish1Reason==8"></i><i
									class="far fa-fw fa-circle" ng-show="Finish1Reason!=8"></i> <s:message
										code="notifyFinish1Reason8" /> </span> <span
									ng-show="Finish1Reason==8"
							...
							<div class="form_group">
								<label class="form_label form_label_search form_label_gray"><s:message
									...
									class="far fa-fw fa-circle" ng-show="Finish2Reason!=6"></i> <s:message
										code="notifyFinish2Reason6" /> </span> <span><i
									class="far fa-fw fa-dot-circle" ng-show="Finish2Reason==7"></i><i
									class="far fa-fw fa-circle" ng-show="Finish2Reason!=7"></i> <s:message
										code="notifyFinish2Reason7" /> </span> <span
									ng-show="Finish2Reason==7"
							...
							<div class="form_group">
								<label class="form_label form_label_search form_label_gray"><s:message
									...
									class="far fa-fw fa-circle" ng-show="Finish4Reason!=5"></i> <s:message
										code="notifyFinish4Reason5" /> </span> <span><i
									class="far fa-fw fa-dot-circle" ng-show="Finish4Reason==6"></i><i
									class="far fa-fw fa-circle" ng-show="Finish4Reason!=6"></i> <s:message
										code="notifyFinish4Reason6" /> </span><label
									class="input_for_radio_group"> <span
									ng-show="Finish4Reason==6"
			...
			<div class="row tab_block text-center">
				...
				<button class="btn btn_custom btn_blue"
					ng-click="examine(Id,'undo')" ng-show="reject"
					ng-disabled="!viewForm.$valid">
					<i class="fas fa-fw fa-check"></i>
