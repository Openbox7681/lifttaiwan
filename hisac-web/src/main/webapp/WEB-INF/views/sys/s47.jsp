...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/sys/s47.js"></script>
				...
				<table
					...
					<thead>
						<tr>
							...
							<th width="45%"><span>CI會員資料</span></th>
							
						</tr>
					</thead>
					<tbody>
						<tr ng-repeat="item in OrgCiLevelList">
							<td>{{item.OrgId}}</td>
							...
							<input type="radio"
								ng-model="item.CiLevel" ng-value="'0'"
								> 
								<s:message code="orgCILevel0" />
								</span>
								<span class = "form_input_search">
									<input type="radio"
								ng-model="item.CiLevel" ng-value="'1'"
								>
								<s:message code="orgCILevel1" />
								</span>
								
								<span class = "form_input_search">
									<input type="radio"
								ng-model="item.CiLevel" ng-value="'2'"
								> 
								<s:message code="orgCILevel2" />
								</span>
							<span class = "form_input_search">
								<input type="radio"
								ng-model="item.CiLevel" ng-value="'10'"
								> 
								尚未設定
								</span>
