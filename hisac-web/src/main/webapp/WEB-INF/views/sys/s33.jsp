...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/sys/s33.js"></script>
						...
						<div class="form_group">
							...
							<div class="form_input form_input_search">
								<input type="text" id="QueryId" name="QueryId"
									...
									placeholder="<s:message code="s34Id" />"
									autocomplete="off">
							</div>
						</div>
					</div>
						...
						<div class="form_group">
							...
							<div class="form_input form_input_search">
								<input type="text" id="QueryName" name="QueryName"
									...
									placeholder="<s:message code="s34Name" />"
									autocomplete="off">
							</div>
						</div>
					</div>
					...
					<thead>
						<tr>
							<th><a href="" ng-click="setSortName('id')"> <s:message
										code="s34Id" /> <i ng-show="sorttype != 'id'"
							...
							<th><a href="" ng-click="setSortName('name')"> <s:message
										code="s34Name" /> <i ng-show="sorttype != 'name'"
									class="fas fa-fw fa-sort text-muted"></i><i
