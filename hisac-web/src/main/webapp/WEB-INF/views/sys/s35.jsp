...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/sys/s35.js"></script>
<script>
						...
						<div class="form_group">
							...
							<div class="form_input form_input_search">
								<input type="text" id="QueryTitle" name="QueryTitle"
									...
									placeholder="<s:message code="s35Title" />" autocomplete="off">
							</div>
						</div>
					</div>
					<div>
					...
					<thead>
						<tr>
							...
							<th><a href="" ng-click="setSortName('title')"> <s:message
										code="s35Title" /> <i ng-show="sorttype != 'title'"
							...
							<th><s:message	code="s35StartDateTime" /> 
							<th><s:message	code="s35EndDateTime" />
				...
				<form name="editForm">
					...
					<div >
						<div class="form_group">
							<label for="Content"
								class="form_label form_label_search form_label_gray"><s:message
									code="s35Content" /></label>
							<div class="form_input form_input_search">
								<textarea type="text" id="Content" name="Content"
									ng-model="Content" class="form-control"
									placeholder="<s:message code="s35Content" />" rows="10"
									autocomplete="off"></textarea>
							</div>
							<label for="IsBreakLink"
								class="form_label form_label_search form_label_gray"><s:message
									code="s35IsBreakLink" /></label>
							<div class="form_input form_input_search_half">
								<toggle ng-model="IsBreakLink" ng-init="IsBreakLink=true"
									on='<i class="far fa-fw fa-check-circle"></i><s:message code="s35IsBreakLinkTrue" />'
									off='<i class="fas fa-fw fa-minus-circle"></i><s:message code="s35IsBreakLinkFalse" />'
					...
					<div>
						<div class="form_group">
							...
							<div class="form_input form_input_half">
								<div class="input-group">
									<input type="text" id="StartDateTime" name="StartDateTime"
										...
										placeholder="<s:message code="s35StartDateTime" />"
							...
							<div class="form_input form_input_half">
								<div class="input-group">
									<input type="text" id="EndDateTime" name="EndDateTime"
										...
										placeholder="<s:message code="s35EndDateTime" />"
										autocomplete="off" ng-required="true"><span
										class="input-group-addon"> <i
										class="fas fa-calendar-alt"></i>
									</span>
							...
							<h5 class="text-danger"
								...
								<s:message code="pleaseEnter" />
								<s:message code="s35StartDateTime" />
							</h5>
							<h5 class="text-danger"
								ng-show="editForm.EndDateTime.$error.required && editForm.EndDateTime.$dirty">
								<s:message code="pleaseEnter" />
								<s:message code="s35EndDateTime" />
							</h5>
						</div>
					</div>
					<div>
			...
			<div class="col-xs-12 shadow_board">
				...
				<div>
					<div class="col-xs-12 col-sm-6 col-md-4"
						...
						<div class="thumbnail">
							<img src="./api/s35/pic/download/{{Id}}/{{item.Id}}"
						...
						<div class="thumbnail">
							<div class="caption">
								...
								<p>
									...
									: <a href="./api/s35/attach/download/{{item.CommonPostId}}/{{item.Id}}" target="_blank">{{item.FileName}}</a>
								</p>
								<p>
