...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/sys/s38.js"></script>
				...
				<form name="queryForm">
					...
					<div>
						<div class="form_group">
							<label for="QueryName"
								class="form_label form_label_search form_label_gray"><s:message
									code="newsManagementGroupName" /></label>
							<div class="form_input form_input_search">
								<input type="text" id="QueryName" name="QueryName"
									ng-model="QueryName" class="form-control"
									placeholder="<s:message code="newsManagementGroupName" />"
									autocomplete="off">
							</div>
						</div>
					</div>
					...
					<thead>
						<tr>
							<th><a href="" ng-click="setSortName('id')"> <s:message
										code="newsManagementGroupId" /> <i ng-show="sorttype != 'id'"
							...
							<th><a href="" ng-click="setSortName('name')"> <s:message
										code="newsManagementGroupName" /> <i ng-show="sorttype != 'name'"
									class="fas fa-fw fa-sort text-muted"></i><i
						...
						<div class="form_group">
							...
							<div class="form_input form_input_search">
								...
								<h5 class="text-danger"
									...
									<s:message code="newsManagementGroupName" />
								</h5>
								<h5 class="text-danger"
