...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/sys/s31.js"></script>
<script>
		...
		<div class="row">
			...
			<div class="col-xs-12 shadow_board">
				<form name="queryForm">
					...
					<div>
						<div class="form_group">
							<label for="QueryNewsManagementGroupId"
								class="form_label form_label_search form_label_gray"><s:message
									code="s31NewsManagementGroup" /></label>
							<div class="form_input form_input_search">
								<select id="QueryNewsManagementGroupId"
									name="QueryNewsManagementGroupId"
									ng-model="QueryNewsManagementGroupId"
									class="form-control col-xs-6"
									ng-options="newsManagementGroup.Id as newsManagementGroup.Id+'-'+newsManagementGroup.Name for newsManagementGroup in newsManagementGroups">
					...
					<div>
						<div class="form_group">
							<label for="QueryStatus"
								class="form_label form_label_search form_label_gray"><s:message
									code="s31Status" /></label>
							<div class="form_input form_input_search">
								<select id="QueryStatus" name="QueryStatus"
									ng-model="QueryStatus" class="form-control col-xs-6">
									<option value="" selected><s:message code="all" /></option>
									<option value="1"><s:message code="s31StatusOpt1" /></option>
									<option value="2"><s:message code="s31StatusOpt2" /></option>
									<option value="3"><s:message code="s31StatusOpt3" /></option>
									<option value="4"><s:message code="s31StatusOpt4" /></option>
									<option value="5"><s:message code="s31StatusOpt5" /></option>
									<!-- <option value="6"><s:message code="s31StatusOpt6" /></option> -->
								</select>
							</div>
						</div>
					</div>
								...
								<div class="text-center">
									<c:if
										...
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s31StatusQueryBtn1" />
										...
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s31StatusQueryBtn2" />
											<c:if test="${isHisacContent}">
												{{ButtonCount2}}
											</c:if>
										</button>
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s31StatusQueryBtn3" />
										...
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s31StatusQueryBtn4" />
										</button>
										<button class="btn btn-primary btn_bottom_fix"
											ng-click="setStatus('5');">
											<s:message code="s31StatusQueryBtn5" />
										</button>
										<!-- <button class="btn btn-primary btn_bottom_fix"
											ng-click="setStatus('6');">
											<s:message code="s31StatusQueryBtn6" />
										</button> -->
									</c:if>
								</div>
							</div>
				...
				<table
					...
					<thead>
						<tr>
							<th><a href="" ng-click="setSortName('postId')"> <s:message
										code="s31PostId" /> <i ng-show="sorttype != 'postId'"
							...
							<th><a href="" ng-click="setSortName('title')"> <s:message
										code="s31Title" /> <i ng-show="sorttype != 'title'"
									class="fas fa-fw fa-sort text-muted"></i><i
							...
							<th><a href=""
								ng-click="setSortName('newsManagementGroupName')"> <s:message
										code="s31NewsManagementGroup" /> <i
									ng-show="sorttype != 'newsManagementGroupName'"
									class="fas fa-fw fa-sort text-muted"></i><i
									ng-show="sorttype == 'newsManagementGroupName' && !sortreverse"
									class="fas fa-fw fa-caret-down"></i> <i
									ng-show="sorttype == 'newsManagementGroupName' && sortreverse"
									class="fas fa-fw fa-caret-up"></i>
							</a></th>
							<th><a href="" ng-click="setSortName('sourceName')"> <s:message
										code="s31SourceName" /> <i ng-show="sorttype != 'sourceName'"
									class="fas fa-fw fa-sort text-muted"></i><i
					...
					<tbody>
						<tr ng-repeat="item in allitems">
							...
							<td>{{item.NewsManagementGroupName}}</td>
				...
				<form name="editForm">
						...
						<div class="form_group">
							<label for="NewsManagementGroupId"
								class="form_label form_label_search form_label_gray"><s:message
									code="s31NewsManagementGroup" /></label>
							<div class="form_input form_input_search">
								<select id="NewsManagementGroupId" name="NewsManagementGroupId"
									ng-model="NewsManagementGroupId" class="form-control col-xs-6"
									ng-options="newsManagementGroup.Id as newsManagementGroup.Id+'-'+newsManagementGroup.Name for newsManagementGroup in newsManagementGroups"
									ng-required="true">
									<option value="" selected><s:message
											code="pleaseSelect" />
										<s:message code="s31NewsManagementGroup" /></option>
								</select>
								<h5 class="text-danger"
									ng-show="editForm.NewsManagementGroupId.$error.required && editForm.NewsManagementGroupId.$dirty">
									<s:message code="pleaseSelect" />
									<s:message code="s31NewsManagementGroup" />
								</h5>
							</div>
						</div>
					</div>
						...
						<div class="form_group">
							...
							<div class="form_input form_input_search">
								...
								<h5 class="text-danger"
									...
									<s:message code="s31PostDateTime" />
								</h5>
							</div>
						</div>
					</div>
					...
					<div>
						<div class="form_group">
							<label for="ContentType"
								class="form_label form_label_search form_label_gray"><s:message
									code="s31ContentType" /></label> <span> <input type="radio"
								...
								for="ContentType2" class="label_for_radio"><s:message
										code="s31ContentType2" /></label>
							</span>
						</div>
						<h5 class="text-danger"
							ng-show="editForm.ContentType.$error.required">
							<s:message code="pleaseSelect" />
							<s:message code="s31ContentType" />
						</h5>
					</div>
					<div ng-show="ContentType=='1'">
						<div class="form_group">
							<label for="Content"
								class="form_label form_label_search form_label_gray"><s:message
									code="s31Content" /></label>
							<div class="form_input form_input_search">
								<textarea type="text" id="Content" name="Content"
									ng-model="Content" class="form-control"
									placeholder="<s:message code="s31Content" />" rows="10"
									autocomplete="off" ng-requird="true"></textarea>
							</div>
							<label for="IsBreakLine"
								class="form_label form_label_search form_label_gray"><s:message
									code="s31IsBreakLine" /></label>
							<div class="form_input form_input_search_half">
								<toggle ng-model="IsBreakLine" ng-init="IsBreakLine=true"
									on='<i class="far fa-fw fa-check-circle"></i><s:message code="s31IsBreakLineTrue" />'
									off='<i class="fas fa-fw fa-minus-circle"></i><s:message code="s31IsBreakLineFalse" />'
							...
							<div class="form_input form_input_half">
								<div class="input-group">
									<input type="text" id="StartDateTime" name="StartDateTime"
										...
										placeholder="<s:message code="s31StartDateTime" />"
										autocomplete="off"><span class="input-group-addon">
										<i class="fas fa-calendar-alt"></i>
									</span>
								</div>
							...
							<div class="form_input form_input_half">
								<div class="input-group">
									<input type="text" id="EndDateTime" name="EndDateTime"
										...
										placeholder="<s:message code="s31EndDateTime" />"
										autocomplete="off"><span class="input-group-addon">
										<i class="fas fa-calendar-alt"></i>
									</span>
								</div>
						...
						<div class="form_group">
							...
							<div class="form_input form_input_search">
								<select id="Status" name="Status"
									...
									ng-required="true">
									<option value="" ng-selected="!Status">--<s:message code="pleaseSelect" /><s:message code="s31Status" />--</option>
									<option ng-value="1" ng-selected="Status == '1'"><s:message code="s31StatusOpt1" /></option>
									<option ng-value="2" ng-selected="Status == '2'"><s:message code="s31StatusOpt2" /></option>
									<option ng-value="3" ng-selected="Status == '3'"><s:message code="s31StatusOpt3" /></option>
									<option ng-value="4" ng-selected="Status == '4'"><s:message code="s31StatusOpt4" /></option>
									<option ng-value="5" ng-selected="Status == '5'"><s:message code="s31StatusOpt5" /></option>
									<option ng-value="6" ng-selected="Status == '6'"><s:message code="s31StatusOpt6" /></option>
								</select>
								<h5 class="text-danger"
									ng-show="editForm.Status.$error.required && editForm.Status.$dirty">
									<s:message code="pleaseSelect" />
									<s:message code="s31Status" />
								</h5>
							</div>
						</div>
					</div>-->
			...
			<div class="col-xs-12 shadow_board">
				...
				<div>
					<div class="col-xs-12 col-sm-6 col-md-4"
						...
						<div class="thumbnail">
							<img src="./api/s31/pic/download/{{Id}}/{{item.Id}}"
						...
						<div class="thumbnail">
							<div class="caption">
								...
								<p>
									...
									: <a
										href="./api/s31/attach/download/{{item.NewsManagementId}}/{{item.Id}}"
			...
			<div class="col-xs-12 shadow_board">
				<form class="form-horizontal" role="form" name="myForm">
					...
					<div>
						<div class="form_group">
							<label class="form_label form_label_search form_label_gray"><s:message
									code="s31PostId" /></label> <span>{{PostId}}</span>
						</div>
					</div>
					<div>
						<div class="form_group">
							<label class="form_label form_label_search form_label_gray"><s:message
									code="s31NewsManagementGroup" /></label> <span>{{NewsManagementGroupName}}</span>
						</div>
					</div>
					<div>
						<div class="form_group">
					...
					<div>
						<div class="form_group">
							<label class="form_label form_label_search form_label_gray"><s:message
									code="s31Title" /></label> <span>{{Title}}</span>
						</div>
					</div>
					<div>
						<div class="form_group">
							<label class="form_label form_label_search form_label_gray"><s:message
									code="s31SourceName" /></label> <span>{{SourceName}}</span>
						</div>
					</div>
					<div>
						<div class="form_group">
							<label class="form_label form_label_search form_label_gray"><s:message
									code="s31SourceLink" /></label> <span>{{SourceLink}}</span>
						</div>
					</div>
					<div>
						<div class="form_group">
							<label class="form_label form_label_search form_label_gray"><s:message
									code="s31ContentType" /></label> <span ng-show="ContentType == '1'"><s:message
									code="s31ContentType1" /></span> <span ng-show="ContentType == '2'"><s:message
									code="s31ContentType2" /></span>
						</div>
					</div>
					<div ng-show="ContentType == '1'">
						<div class="form_group">
					...
					<div>
						<div class="form_group">
							<label class="form_label form_label_search form_label_gray"><s:message
									code="s31StartDateTime" /></label> <span>{{StartDateTime}}</span> <span><s:message
									code="globalDataFromTo" /></span> <br class="visible-xs" /> <label
								class="form_label form_label_search form_label_gray"><s:message
									code="s31EndDateTime" /></label> <span>{{EndDateTime}}</span>
						</div>
					</div>
					<div>
						<div class="form_group">
								...
								<tbody>
									<tr ng-repeat="item in MessageProcessLogData">
										<td><span ng-if="item.PreStatus == 1"><s:message
													code="s31ShowPreStatus1" /></span> <span
											ng-if="item.PreStatus == 2"><s:message
													code="s31ShowPreStatus2" /></span> <span
											ng-if="item.PreStatus == 3"><s:message
													code="s31ShowPreStatus3" /></span> <span
											ng-if="item.PreStatus == 6"><s:message
													code="s31ShowPreStatus6" /></span> <span><i
												class="fas fa-fw fa-arrow-right"></i></span> <span
											ng-if="item.Status == 2"><s:message
													code="s31ShowStatus2" /></span> <span ng-if="item.Status == 3"><s:message
													code="s31ShowStatus3" /></span> <span ng-if="item.Status == 5"><s:message
													code="s31ShowStatus5" /></span> <span ng-if="item.Status == 6"><s:message
													code="s31ShowStatus6" /></span></td>
