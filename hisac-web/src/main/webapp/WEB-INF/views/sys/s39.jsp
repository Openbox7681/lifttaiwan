...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/sys/s39.js"></script>
<script>
								...
								<div class="text-center">
									<c:if
										...
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s39StatusQueryBtn1" />
										...
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s39StatusQueryBtn2" />
											<c:if test="${isHisacContent}">
												{{ButtonCount2}}
											</c:if>
										</button>
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s39StatusQueryBtn3" />
										...
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s39StatusQueryBtn4" />
										</button>
										<button class="btn btn-primary btn_bottom_fix"
											ng-click="setStatus('5');">
											<s:message code="s39StatusQueryBtn5" />
										</button>
										<!-- <button class="btn btn-primary btn_bottom_fix"
											ng-click="setStatus('6');">
											<s:message code="s39StatusQueryBtn6" />
										</button> -->
									</c:if>
								</div>
							</div>
		...
		<div class="row">
			<div class="col-xs-12 shadow_board">
				<form class="form-horizontal" role="form" name="myForm">
					...
					<div>
						<div class="form_group">
							<label class="form_label form_label_search form_label_gray">是否醫療相關</label> 
							<span ng-show="IsMedical == true">是 <span ng-show="IsMedical == false">否</span>
						</div>
					</div>
					<div>
						<div class="form_group">
