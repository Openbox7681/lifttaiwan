...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/sys/s04.js"></script>
						...
						<div class="form_group">
							...
							<div class="form_input form_input_search">
								<input type="text" id="QueryName" name="QueryName"
									...
									placeholder="<s:message code="alertTypeName" />"
									autocomplete="off">
							</div>
						</div>
					</div>
					...
					<thead>
						<tr>
							<th><a href="" ng-click="setSortName('code')"> <s:message
										code="alertTypeCode" /> <i ng-show="sorttype != 'code'"
							...
							<th><a href="" ng-click="setSortName('name')"> <s:message
										code="alertTypeName" /> <i ng-show="sorttype != 'name'"
									class="fas fa-fw fa-sort text-muted"></i><i
