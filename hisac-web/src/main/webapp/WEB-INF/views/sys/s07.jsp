...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/sys/s07.js"></script>
		...
		<div class="row">
			...
			<div class="col-xs-12 shadow_board">
				<form name="queryForm">
					...
					<div>
						<div class="form_group">
							<label for="QueryAlertCode"
								class="form_label form_label_search form_label_gray"><s:message
									code="alertTypeName" /></label>
							<div class="form_input form_input_search">
								<select id="QueryAlertCode" name="QueryAlertCode"
									ng-model="QueryAlertCode" class="form-control col-xs-6"
									ng-options="alertData.Code as alertData.Code+'-'+alertData.Name for alertData in alertTypeCode">
					...
					<div>
						<div class="form_group">
							<label for="QueryStixXsd"
								class="form_label form_label_search form_label_gray"><s:message
									code="eventTypeStixXsd" /></label>
							<div class="form_input form_input_search">
								<input type="text" id="QueryStixXsd" name="QueryStixXsd"
									ng-model="QueryStixXsd" class="form-control"
									placeholder="<s:message code="eventTypeStixXsd" />"
									autocomplete="off">
							</div>
						</div>
					</div>
					...
					<thead>
						<tr>
							<th><a href="" ng-click="setSortName('code')"> <s:message
										code="eventTypeCode" /> <i ng-show="sorttype != 'code'"
							...
							<th><a href="" ng-click="setSortName('name')"> <s:message
										code="eventTypeName" /> <i ng-show="sorttype != 'name'"
									class="fas fa-fw fa-sort text-muted"></i><i
							...
							<th><a href="" ng-click="setSortName('alertCode')"> <s:message
										code="alertTypeCode" /> <i ng-show="sorttype != 'alertCode'"
									class="fas fa-fw fa-sort text-muted"></i><i
									ng-show="sorttype == 'alertCode' && !sortreverse"
									class="fas fa-fw fa-caret-down"></i> <i
									ng-show="sorttype == 'alertCode' && sortreverse"
									class="fas fa-fw fa-caret-up"></i>
							</a></th>
							<th><a href="" ng-click="setSortName('stixxsd')"> <s:message
										code="StixXsd" /> <i ng-show="sorttype != 'stixxsd'"
									class="fas fa-fw fa-sort text-muted"></i><i
									ng-show="sorttype == 'stixxsd' && !sortreverse"
									class="fas fa-fw fa-caret-down"></i> <i
									ng-show="sorttype == 'stixxsd' && sortreverse"
									class="fas fa-fw fa-caret-up"></i>
							</a></th>
						...
						<div class="form_group">
							<label for="StixXsd"
								class="form_label form_label_search form_label_gray"><s:message
									code="StixXsd" /></label>
							<div class="form_input form_input_search">
								<input type="text" id="StixXsd" name="StixXsd"
									ng-model="StixXsd" class="form-control"
									placeholder="<s:message code="StixXsd" />" autocomplete="off"
									ng-required="true" ng-maxlength="16" />
								<h5 class="text-danger"
									ng-show="editForm.StixXsd.$error.required && editForm.StixXsd.$dirty">
									<s:message code="pleaseEnter" />
									<s:message code="StixXsd" />
								</h5>
								<h5 class="text-danger"
									ng-show="editForm.StixXsd.$error.maxlength && editForm.StixXsd.$dirty">
