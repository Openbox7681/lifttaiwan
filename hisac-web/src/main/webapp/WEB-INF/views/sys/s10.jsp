...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/sys/s10.js"></script>
				...
				<form name="queryForm">
					...
					<div>
						<div class="form_group">
							<label for="QueryName"
								class="form_label form_label_search form_label_gray"><s:message
									code="informationSourceName" /></label>
							<div class="form_input form_input_search">
								<input type="text" id="QueryName" name="QueryName"
									ng-model="QueryName" class="form-control"
									placeholder="<s:message code="informationSourceName" />"
									autocomplete="off">
							</div>
						</div>
					</div>
					...
					<thead>
						<tr>
							<th><a href="" ng-click="setSortName('code')"> <s:message
										code="informationSourceCode" /> <i ng-show="sorttype != 'code'"
							...
							<th><a href="" ng-click="setSortName('name')"> <s:message
										code="informationSourceName" /> <i ng-show="sorttype != 'name'"
									class="fas fa-fw fa-sort text-muted"></i><i
						...
						<div class="form_group">
							...
							<div class="form_input form_input_search">
								...
								<h5 class="text-danger"
									...
									<s:message code="informationSourceCode" />
								</h5>
								<h5 class="text-danger"
									ng-show="!editForm.Code.$error.required && editForm.Code.$invalid && editForm.Code.$dirty">
									<s:message code="informationSourceCodeFormat" />
								</h5>
							</div>
						</div>
					</div>
						...
						<div class="form_group">
							...
							<div class="form_input form_input_search">
								...
								<h5 class="text-danger"
									...
									<s:message code="pleaseEnter" />
									<s:message code="informationSourceName" />
								</h5>
							</div>
						</div>
					</div>
