...
<script src="<c:out value="${pageContext.request.contextPath}" />/resources/js/sys/s32.js"></script>
<script>
								...
								<div class="text-center">
									<c:if
										...
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s32StatusQueryBtn1" />
										...
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s32StatusQueryBtn2" />
											<c:if test="${isHisacContent}">
												{{ButtonCount2}}
											</c:if>
										</button>
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s32StatusQueryBtn3" />
										...
										<button class="btn btn-primary btn_bottom_fix"
											...
											<s:message code="s32StatusQueryBtn4" />
										</button>
										<button class="btn btn-primary btn_bottom_fix"
											ng-click="setStatus('5');">
											<s:message code="s32StatusQueryBtn5" />
										</button>
										<!-- <button class="btn btn-primary btn_bottom_fix"
											ng-click="setStatus('6');">
											<s:message code="s32StatusQueryBtn6" />
										</button> -->
									</c:if>
								</div>
							</div>
