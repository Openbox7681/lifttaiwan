...
//	$scope.clearData();
	...
	$scope.queryData = function(page) {
		...
		$http.post('./api/s35/query', request, csrf_config).then(function(response) {
	...
	$scope.editData = function(id) {
		...
		var request = {Id:id};
		$http.post('./api/s35/query/id', request, csrf_config).then(function(response) {
	...
	$scope.createData = function() {
		...
		$http.post('./api/s35/create', request, csrf_config).then(
				function(response) {
	...
	$scope.updateData = function() {
		...
		$http.post('./api/s35/update', request, csrf_config).then(
				function(response) {
					if (response.data.success) {
						$scope.queryData($scope.currentPage);
						bootbox.alert({
		...
		bootbox.confirm({
			...
			callback: function(result) {
				if (result) {
					...
					$http.post('./api/s35/delete', request, csrf_config).then(function(response) {
						if (response.data.success) {
							bootbox.alert({
								message : response.data.msg,
								buttons : {
	...
	$scope.queryImageData = function(id) {
		...
		$http.post('./api/s35/pic/query', request, csrf_config).then(function(response) {
		...
		bootbox.confirm({
			...
			callback: function(result) {
				if (result) {
					...
					$http.post('./api/s35/pic/delete', request, csrf_config).then(function(response) {
						if (response.data.success) {
							$scope.queryImageData($scope.Id);
							bootbox.alert({
								message : response.data.msg,
	...
	$scope.queryAttachmentData = function(id) {
		...
		$http.post('./api/s35/attach/query', request, csrf_config).then(function(response) {
		...
		bootbox.confirm({
			...
			callback: function(result) {
				if (result) {
					...
					//console.log("request=" + JSON.stringify(request));
					$http.post('./api/s35/attach/delete', request, csrf_config).then(function(response) {
