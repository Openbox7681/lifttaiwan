...
//	$scope.clearData();
	...
	$scope.queryData = function(page) {
		...
		$http.post('./api/s34/query', request, csrf_config).then(function(response) {
	...
	$scope.editData = function(id) {
		...
		var request = {Id:id};
		$http.post('./api/s34/query/id', request, csrf_config).then(function(response) {
	...
	$scope.createData = function() {
		...
		$http.post('./api/s34/create', request, csrf_config).then(
				function(response) {
	...
	$scope.updateData = function() {
		...
		$http.post('./api/s34/update', request, csrf_config).then(
				function(response) {
					if (response.data.success) {
						$scope.queryData($scope.currentPage);
						bootbox.alert({
		...
		bootbox.confirm({
			...
			callback: function(result) {
				if (result) {
					...
					$http.post('./api/s34/delete', request, csrf_config).then(function(response) {
						if (response.data.success) {
							bootbox.alert({
								message : response.data.msg,
								buttons : {
	...
	$scope.queryImageData = function(id) {
		...
		$http.post('./api/s34/pic/query', request, csrf_config).then(function(response) {
		...
		bootbox.confirm({
			...
			callback: function(result) {
				if (result) {
					...
					$http.post('./api/s34/pic/delete', request, csrf_config).then(function(response) {
						if (response.data.success) {
							$scope.queryImageData($scope.Id);
							bootbox.alert({
								message : response.data.msg,
	...
	$scope.queryAttachmentData = function(id) {
		...
		$http.post('./api/s34/attach/query', request, csrf_config).then(function(response) {
		...
		bootbox.confirm({
			...
			callback: function(result) {
				if (result) {
					...
					//console.log("request=" + JSON.stringify(request));
					$http.post('./api/s34/attach/delete', request, csrf_config).then(function(response) {
