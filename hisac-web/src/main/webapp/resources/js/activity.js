...
function getAppController($scope, $rootScope, $http, $window) {
	...
	$scope.queryData = function(page) {
		...
		$http.post('./public/api/activity/query', request, csrf_config2).then(function(response) {
	...
	$scope.queryDetailData = function(id) {
		...
		$http.post('./public/api/activity/query/id', request, csrf_config2).then(function(response) {
	...
	$scope.queryDetailAttachData = function(id) {
		...
		$http.post('./public/api/activity/attach/query', request, csrf_config2).then(function(response) {			
