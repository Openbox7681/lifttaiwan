...
function getAppController($scope, $rootScope, $http, $window) {
	...
	$scope.queryData = function(page) {
		...
		$http.post('./public/api/qa/query', request, csrf_config2).then(function(response) {
	...
	$scope.queryDetailData = function(id) {
		...
		$http.post('./public/api/qa/query/id', request, csrf_config2).then(function(response) {
	...
	$scope.queryDetailAttachData = function(id) {					
		...
		$http.post('./public/api/qa/attach/query', request, csrf_config2).then(function(response) {			
